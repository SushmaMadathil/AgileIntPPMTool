...
import io.agileintelligence.ppmtool.payload.JWTLoginSuccessReponse;
...
public class UserController {
    ...
    public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequest loginRequest, BindingResult result){
        ...
        String jwt = TOKEN_PREFIX +  tokenProvider.generateToken(authentication);//TOKEN_PREFIX is brought from the constants declared in SecurityConstants 
